...
_LLM_SYSTEM = (
    ...
    "The COMPLETE roster of playable Lancers is EXACTLY these 13 and NO others: "
    "Broker, Nitro, Hollowpoint, Jaguar, Chum, Corona, Serket, Pathojen, Zephyr, "
    "Spider, Kismet, Axon, Sonar. NEVER name, invent, misspell, or reference any "
    "Lancer outside this exact list. If you are not certain which Lancer a question "
    "refers to, ask or say you're not sure -- do NOT guess or make up a name. "
